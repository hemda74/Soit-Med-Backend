...
{
    public class CreateSparePartsCoordinatorWithImageDTO
    {
    ...
    public class CreatedSparePartsCoordinatorWithImageResponseDTO
    {
        ...
        public SparePartsCoordinatorImageInfo? ProfileImage { get; set; }
        public string Message { get; set; } = string.Empty;
        public int SparePartsCoordinatorId { get; set; }
        public string Specialty { get; set; } = string.Empty;
    }

    public class SparePartsCoordinatorImageInfo
    {
