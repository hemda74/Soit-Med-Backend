...
namespace SoitMed.Services
{
    ...
    public interface IClientService
    {
        ...
        Task<(IEnumerable<ClientResponseDTO> Clients, int TotalCount, int PageNumber, int PageSize)> GetAllClientsAsync(int pageNumber = 1, int pageSize = 25, string? searchTerm = null);
        #endregion
