...
namespace SoitMed.Services
{
    public interface IChatService
    {
        ...
        Task<ChatMessageResponseDTO> SendTextMessageAsync(long conversationId, string senderId, string content, bool isAdmin, CancellationToken cancellationToken = default);
        Task<ChatMessageResponseDTO> SendVoiceMessageAsync(long conversationId, string senderId, string voiceFilePath, int voiceDuration, bool isAdmin, CancellationToken cancellationToken = default);
