...
namespace SoitMed.Services
{
    public interface INotificationService
    {
        ...
        Task SendNotificationToRoleGroupAsync(string role, string title, string message, Dictionary<string, object>? metadata = null, CancellationToken cancellationToken = default);
