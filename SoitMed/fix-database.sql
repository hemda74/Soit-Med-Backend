-- =====================================================
-- Database Fix and Data Seeding Script
-- =====================================================
-- This script will fix the database structure and seed data

PRINT '=====================================================';
PRINT 'STARTING DATABASE FIX AND DATA SEEDING';
PRINT '=====================================================';
...
-- =====================================================
-- Step 2: Drop existing WeeklyPlans table if it exists (with wrong structure)
-- =====================================================
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WeeklyPlans]') AND type in (N'U'))
BEGIN
    PRINT 'Dropping existing WeeklyPlans table...';
    DROP TABLE [WeeklyPlans];
    PRINT 'WeeklyPlans table dropped.';
END

-- =====================================================
-- Step 3: Drop existing WeeklyPlanItems table if it exists
-- =====================================================
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WeeklyPlanItems]') AND type in (N'U'))
BEGIN
    PRINT 'Dropping existing WeeklyPlanItems table...';
    DROP TABLE [WeeklyPlanItems];
    PRINT 'WeeklyPlanItems table dropped.';
END

-- =====================================================
-- Step 4: Create WeeklyPlans table with correct structure
-- =====================================================
PRINT 'Creating WeeklyPlans table...';
...
-- =====================================================
-- Step 5: Create WeeklyPlanItems table
-- =====================================================
PRINT 'Creating WeeklyPlanItems table...';
...
-- =====================================================
-- Step 6: Create Clients table if it doesn't exist
-- =====================================================
...
-- =====================================================
-- Step 8: Get User ID for ahmed@soitmed.com
-- =====================================================
...
-- =====================================================
-- Step 11: Insert Weekly Plan Items
-- =====================================================
...
PRINT '';
PRINT '=====================================================';
PRINT 'DATABASE FIX AND DATA SEEDING COMPLETED SUCCESSFULLY!';
PRINT '=====================================================';
