...
namespace SoitMed.Repositories
{
    public interface IEquipmentRepository : IBaseRepository<Equipment>
    {
        ...
        Task<Equipment?> GetEquipmentWithHospitalAsync(int id, CancellationToken cancellationToken = default);
        Task<Equipment?> GetEquipmentWithRepairRequestsAsync(int id, CancellationToken cancellationToken = default);
        Task<Equipment?> GetEquipmentWithAllDetailsAsync(int id, CancellationToken cancellationToken = default);
        Task<bool> ExistsByQRCodeAsync(string qrCode, CancellationToken cancellationToken = default);
        Task<bool> ExistsByQRCodeExcludingIdAsync(string qrCode, int id, CancellationToken cancellationToken = default);
