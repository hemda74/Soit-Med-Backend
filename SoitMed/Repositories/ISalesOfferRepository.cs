...
namespace SoitMed.Repositories
{
    ...
    public interface ISalesOfferRepository : IBaseRepository<SalesOffer>
    {
        ...
        Task<List<SalesOffer>> GetOffersByClientIdAsync(string clientId);
        ...
        Task<List<SalesOffer>> GetOffersByOfferRequestAsync(string offerRequestId);
        Task<SalesOffer?> GetOfferWithDetailsAsync(string offerId);
        ...
        Task<List<SalesOffer>> GetByIdsAsync(IEnumerable<string> ids);
        
        // Optimized methods that load related data in a single query
        Task<(List<SalesOffer> Offers, Dictionary<string, Client> Clients, Dictionary<string, ApplicationUser> Users)> 
